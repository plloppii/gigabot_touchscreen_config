...
cp $PWD/usb/usbmount.conf /etc/usbmount/usbmount.conf
cp $PWD/usb/00_create_model_symlink /etc/usbmount/mount.d/
cp $PWD/usb/00_remove_model_symlink /etc/usbmount/umount.d/
...
cp $PWD/usb/systemd-udevd.service /lib/systemd/system/systemd-udevd.service
